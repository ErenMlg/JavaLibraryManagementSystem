...
public class UpdateAcademicianLibrarian extends javax.swing.JFrame {
    ...
    private Academician selectedAcademician;
    
    public UpdateAcademicianLibrarian(Librarian librarian, Academician member) {
        initComponents();
        CenterScreen.centerScreen(this);
        etID.setInputVerifier(idVerifier);
        currentLibrarian = librarian;
        selectedAcademician = member;
        etAdress.setText(selectedAcademician.getMemberAddress());
        etBookLimit.setText(String.valueOf(selectedAcademician.getMemberRight()));
        etGradeOrTitle.setText(selectedAcademician.getTitle());
        etID.setText(selectedAcademician.getUserID());
        etMail.setText(selectedAcademician.getMemberMail());
        etName.setText(selectedAcademician.getMemberFirstName());
        etSurname.setText(selectedAcademician.getMemberSurname());
        etPhone.setText(selectedAcademician.getMemberPhone());
        etUsername.setText(selectedAcademician.getMemberUsername());
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblGradeOrTitle, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(46, 46, 46))
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel3.add(jPanel2);
        jPanel2.setBounds(210, 0, 970, 440);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        String title = etGradeOrTitle.getText();
        result = service.updateMember(memberID, memberName, memberSurname, memberPhone, memberAddress, memberMail, memberUsername, departmantID, "", 0, etGradeOrTitle.getText(), "Academician");
        if(!result){
