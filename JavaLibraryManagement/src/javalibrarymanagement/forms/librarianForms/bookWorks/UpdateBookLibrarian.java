...
public class UpdateBookLibrarian extends javax.swing.JFrame {
    ...
    public UpdateBookLibrarian(Librarian librarian, Book book) {
        ...
        etName.setText(book.getBookName());
        ...
        cbAuthor.setSelectedIndex(findIndexAuthorName(book.getAuthor()));
        cbCategory.setSelectedIndex(findIndexCategoryName(book.getCategoryName()));
        cbLocation.setSelectedIndex(findIndexLocationName(book.getLocation()));
        cbPublisher.setSelectedIndex(findIndexPublisherName(book.getPublisherName()));
    }
    ...
    private void initComponents() {
        ...
        etYear.setEditable(false);
        etYear.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(etYear, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(etYear, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(etEdition, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private int findIndexAuthorName(String searchKey){
        int index=0;
        for(Author author:authorList){
            if(author.getAuthorName().equals(searchKey)){
              return index;
    ...
    private int findIndexPublisherName(String searchKey){
        int index=0;
        for(Publisher publisher:publisherList){
            if(publisher.getName().equals(searchKey)){
              return index;
    ...
    private int findIndexCategoryName(String searchKey){
        int index=0;
        for(Categories category:categoryList){
            if(category.getCategoryName().equals(searchKey)){
              return index;
    ...
    private int findIndexLocationName(String searchKey){
        int index=0;
        for(Location location:locationList){
            if(location.getLocation().equals(searchKey)){
              return index;
