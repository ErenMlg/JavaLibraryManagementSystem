...
import javalibrarymanagement.repository.deleteRepo.allDeletes;
 ...
 * @author erenm
 */
public class BookRequestForMember extends javax.swing.JFrame {
    ...
    public BookRequestForMember(Member member) {
        initComponents();
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        if(selectedRow != -1){
            Boolean res = allDeletes.deleteRequestFromUser(tblRequests.getValueAt(selectedRow, 0).toString(), currentMember);
            if(res){
    ...
    private void getAndFillTable(){
        ArrayList<Object[]> requests = allGets.getMyRequests(currentMember.getUserID());
