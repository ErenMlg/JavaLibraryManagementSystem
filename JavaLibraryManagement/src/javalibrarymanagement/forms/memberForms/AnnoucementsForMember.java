...
public class AnnoucementsForMember extends javax.swing.JFrame {
    ...
    public AnnoucementsForMember(Member member) {
        ...
        model = (DefaultTableModel)tblAnnoucements.getModel();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        tblAnnoucements.setDefaultRenderer(String.class, centerRenderer);
        tblAnnoucements.setDefaultRenderer(int.class, centerRenderer);
        currentMember = member;
        for(Annoucement events:allAnnoucements){
            Object[] row = {
                events.getAnnoucementName(),
                events.getAnnoucementDesc(),
                events.getAnnoucementDate()
            };
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        tblAnnoucements = new javax.swing.JTable();
        ...
        tblAnnoucements.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblAnnoucements.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(tblAnnoucements);
        if (tblAnnoucements.getColumnModel().getColumnCount() > 0) {
            tblAnnoucements.getColumnModel().getColumn(0).setResizable(false);
            tblAnnoucements.getColumnModel().getColumn(1).setResizable(false);
            tblAnnoucements.getColumnModel().getColumn(2).setResizable(false);
        }
        ...
        txtRights.setText("Annoucements");
    ...
    private javax.swing.JTable tblAnnoucements;
